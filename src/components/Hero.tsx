        ...
        <div className="relative z-10 text-center w-full max-w-7xl mx-auto">
          ...
          <div className="space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8">
            ...
            <div className="mb-4 sm:mb-6">
              <div className="inline-block bg-red-900/30 backdrop-blur-sm border border-red-500/50 rounded-full px-4 sm:px-6 md:px-8 py-2 sm:py-3">
                <span className="text-red-400 text-sm sm:text-base md:text-lg font-semibold tracking-wider flex items-center space-x-2">
                  <div className="w-2 h-2 bg-red-400 rounded-full animate-pulse"></div>
                  <span>REGISTRATION CLOSES ON MONDAY</span>
                </span>
              </div>
            </div>
